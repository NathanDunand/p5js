  ...
  let haut=copier_pixel(x, y);
  let droite=copier_pixel(x, y);
  let bas=copier_pixel(x, y);
  let gauche=copier_pixel(x, y);
  let r=(centre[0]+haut[0]+droite[0]+bas[0]+gauche[0])%500;
  let g=(centre[1]+haut[1]+droite[1]+bas[1]+gauche[1])%500;
  let b=(centre[2]+haut[2]+droite[2]+bas[2]+gauche[2])%500;
